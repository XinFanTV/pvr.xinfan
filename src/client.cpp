...
PVRXinFanData   *m_data           = NULL;
bool           m_bIsPlaying     = false;
PVRXinFanChannel m_currentChannel;
...
ADDON_STATUS ADDON_Create(void* hdl, void* props)
{
  ...
  XBMC->Log(LOG_DEBUG, "%s - Creating the PVR XinFan.TV add-on", __FUNCTION__);
...
{
  static const char *strBackendName = " XinFan.TV pvr add-on";
...
{
  snprintf(signalStatus.strAdapterName, sizeof(signalStatus.strAdapterName), "pvr XinFan.TV adapter 1");
